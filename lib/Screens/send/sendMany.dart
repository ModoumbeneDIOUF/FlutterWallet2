...
class SendMany extends StatefulWidget {
  const SendMany({ Key? key }) : super(key: key);

  @override
  _SendManyState createState() => _SendManyState();
}

class _SendManyState extends State<SendMany> {
          ...
          child: TextField(
            decoration: InputDecoration(
             // prefix: Icon(Icons.search),
              labelText: getTranslated(context,"send_money_home_search_hint_text").toString(),
            ),
            onChanged: (value){
                 ...
                 Navigator.push(
                        ...
                        new MaterialPageRoute(
                            builder: (context) => EnvoyerAUnNumero(
                              transfertType: getTranslated(context,"send_money_home_send_to_number_text").toString(),
                            )));
              },
              title: Text(
